...
const NavigationProfile = ({ user }: NavigationProfileType) => {
  ...
  return (
    <div className="batman-store__header-profile--wallpaper">
      <NavLink to="/profile">
        <div className="batman-store__header-profile">
          ...
          <div className="batman-store__header-profile_name-status">
            <p className="batman-store__header-profile_name">
              {lastname} {name}{" "}
            </p>
            <p className="batman-store__header-profile_status">
              {root} account
            </p>
          </div>
      ...
      <p
        onClick={signOutChange}
        className="batman-store__header-profile--signout"
      >
        SignOut
      </p>
    </div>
