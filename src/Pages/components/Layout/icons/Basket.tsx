const Basket = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M15.3401 15.28C15.4401 14.95 15.5001 14.61 15.5001 14.25" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M8.5 14.25C8.5 16.17 10.08 17.75 12 17.75C12.36 17.75 12.71 17.69 13.04 17.59" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <path d="M4.90991 18.64C5.22991 20.58 5.99991 22 8.85991 22H14.8899C17.9999 22 18.4599 20.64 18.8199 18.76L20.4999 10" stroke="#292D32" stroke-width="1.5" stroke-linecap="round"/>
