...
const ProductDetail = () => {
  ...
  }, [dispatch, params?.productId, selectProductEmpty.length]);
  return (
      ...
      <div className="batman-store__product">
        ...
        <div className="batman-store__produc--info">
          ...
          <div className="batman-store__produc--info-more">
            {selectProduct?.brand ? (
              <div className="batman-store__produc--info-data">
                <p>Brand:</p> <h4>{selectProduct?.brand}</h4>{" "}
              </div>
            ) : null}
            {selectProduct?.model ? (
              <div className="batman-store__produc--info-data">
                <p>Model:</p> <h4>{selectProduct?.model}</h4>{" "}
              </div>
            ) : null}
