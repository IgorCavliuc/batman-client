    ...
    <div className="batman-ui--sign-up-content content">
      <form onSubmit={handleSubmit(onSubmit)} className="form">
        ...
        {errors?.data_birthday && (
          <div style={{ color: "#3a48f5" }}>*{errors.data_birthday.message}</div>
        )}

        {/* Img */}
<div className='agent-store--ui-profile-input-media'>
        {base64Image ? <img src={base64Image}  onClick={()=>setBase64Image('')} alt="base64Image" /> :
          <>
        <input
          {...register("img", {
  ...
  <Atach />
        ...
        />
        {errors?.position && (
          <div style={{ color: "#3a48f5" }}>*{errors.position.message}</div>
        )}
